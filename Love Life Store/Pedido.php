...
<!--    <a href="Cadastrar Produtos.php"><input type="submit"  value="Cadastrar Produtos" ></a>-->
    ...
    $res = mysql_query("SELECT * FROM Pedidos"); /* Executa o comando SQL, no caso para pegar todos os usuarios do sistema e retorna o valor da consulta em uma variavel ($res)  */
    echo "<center><table>
        <br><br><br><br>
        <center><legend>Produtos 🍉 🍹 </legend></center><br><br>
        <tr>
        <th width='50'><b><i>Nº</td></i></b> 
        <th width='50'><b><i>Nome do Cliente</td></i></b> 
        <th width='50'><b><i>Pedido (Suco)</td></i></b> 
       
        <th width='250'><b><i>Quantidade</td></i></b>
    ...
    while ($escrever = mysql_fetch_array($res)) {
        ...
        echo "<tr><td value='id_Produtos'>" . $escrever['ID_Pedido'] . "</td><td>" . $escrever['Login'] . "</td><td>" . $escrever['Pedido'] . "</td><td>" . $escrever['Quantidade'] .
